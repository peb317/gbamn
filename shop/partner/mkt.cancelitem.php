...
$sql_common = " from {$g5['g5_shop_cart_table']} a, {$g5['g5_shop_item_table']} b, {$g5['g5_shop_order_table']} c where a.it_id = b.it_id and a.mk_id = '{$member['mb_id']}' and (a.ct_status = '취소' or a.ct_status = '반품') and a.ct_select = '1' and a.od_id = c.od_id and c.od_refund_price > 0 and SUBSTRING(a.pt_datetime,1,10) between '$fr_day' and '$to_day' ";
