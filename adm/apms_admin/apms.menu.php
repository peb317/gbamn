...
<div class="tbl_head01 tbl_wrap">
	...
	<?php if(USE_PARTNER) { ?>
		<th width=60>파트너</th>
	<?php } ?>
	<th width=100>PC 그룹스킨</th>
	<th width=100>모바일 그룹스킨</th>
	<th width=140>PC 그룹테마</th>
	<th width=140>모바일 그룹테마</th>
	<th width=40>보기</th>
	</tr>
	</thead>
	<tbody>
	...
	?>
		...
		<?php } ?>
		<td align="center">
			<select name="as_main[<?php echo $z; ?>]" style="width:90px;">
		...
		<td align="center">
			<select name="as_mobile_main[<?php echo $z; ?>]" style="width:90px;">
				<option value="">사용안함</option>
				<?php
				for ($k=0; $k<count($groupskin); $k++) {
...
<?php if(IS_YC) { ?>
	...
	<div class="tbl_head01 tbl_wrap">
		...
		<?php if(USE_PARTNER) { ?>
			<th width=60>파트너</th>
		<?php } ?>
		<th width=140>PC 분류테마</th>
		<th width=140>모바일 분류테마</th>
		<th width=40>보기</th>
		</tr>
		</thead>
		<tbody>
