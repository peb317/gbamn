...
switch($ap) {
	...
	case 'mlist'	: $sub_menu = '888005'; $g5['title'] = '마케터관리'; break;
...
//Check
$chk_ap = array('install', 'update', 'thema', 'menu', 'bpage', 'npage', 'shingo', 'basic', 'plist', 'pform', 'mlist', 'delivery', 'payment');
...
if($mode) {
	...
	$chk_mode = array('install', 'thema', 'menu', 'bpage', 'npage', 'shingo', 'basic', 'plist', 'pform', 'mlist', 'delivery', 'payment');
