...
<section>
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td>
                부가세를 제한 판매금액의 <input type="text" name="apms_commission_1" value="<?php echo $apms['apms_commission_1'] ?>" id="apms_commission_1" class="required numeric frm_input" size="4"> % 를 판매자(셀러)에게 적립
			</td>
		</tr>
		<tr>
			<th scope="row">컨텐츠상품 수수료</th>
            <td>
                부가세를 제한 판매금액의 <input type="text" name="apms_commission_2" value="<?php echo $apms['apms_commission_2'] ?>" id="apms_commission_2" class="required numeric frm_input" size="4"> % 를 판매자(셀러)에게 적립
			</td>
		</tr>
		<tr>
