...
this.form.pt_leave.value=this.value; } else { this.form.pt_leave.value=this.form.pt_leave.defaultValue; }">
	...
	<tr>
        ...
        <td>부가세를 제한 판매금액의 <input type="text" name="pt_commission_1" value="<?php echo $mb['pt_commission_1'] ?>" class="numeric sit_camt frm_input" size="4"> %를 판매자(셀러)에게 적립</td>
	...
	<tr>
        ...
        <td>부가세를 제한 판매금액의 <input type="text" name="pt_commission_2" value="<?php echo $mb['pt_commission_2'] ?>" class="numeric sit_camt frm_input" size="4"> %를 판매자(셀러)에게 적립</td>
