...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<input type="text" name="wset[gap]" value="<?php echo $wset['gap']; ?>" class="frm_input" size="4"> px 좌우간격(기본 30)
			&nbsp;
			<input type="text" name="wset[gapb]" value="<?php echo $wset['gapb']; ?>" class="frm_input" size="4"> px 상하간격(기본 10)
			&nbsp;
	...
	<tr>
		...
		<td>
			...
			&nbsp;
			<label><input type="checkbox" name="wset[cont]" value="1"<?php echo get_checked('1', $wset['cont']); ?>> 내용숨김</label>
			&nbsp;
