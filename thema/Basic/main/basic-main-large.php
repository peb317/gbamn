...
<div class="container widget-index">
	...
	<div class="row at-row">
		...
		<div class="col-md-9<?php echo ($side == "left") ? ' pull-right' : '';?> at-col at-main">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-garo', $wid.$wn, 'icon={아이콘:caret-right} date=1 center=1 strong=1,2'); $wn++; ?>
					</div>
					<!-- 이슈 끝-->
				...
				<div class="col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-sero', $wid.$wn, 'icon={아이콘:caret-right} date=1 center=1 strong=1,2'); $wn++; ?>
					</div>
					<!-- 뉴스 끝 -->
			...
			<div class="widget-box">
				<?php echo apms_widget('basic-post-gallery', $wid.$wn, 'center=1'); $wn++; ?>
			</div>
			<!-- 갤러리 끝 -->	
			...
			<div class="widget-box">
				<?php echo apms_widget('basic-post-webzine', $wid.$wn, 'bold=1 date=1'); $wn++; ?>
			</div>
			<!-- 웹진 끝 -->	
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-mix', $wid.$wn, 'icon={아이콘:caret-right} bold=1 idate=1 date=1 strong=1'); $wn++; ?>
					</div>
					<!-- 가이드 끝 -->
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-list', $wid.$wn, 'icon={아이콘:caret-right} date=1 strong=1'); $wn++; ?>
					</div>
					<!-- Q & A 끝 -->
				...
				<div class="col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-list', $wid.$wn, 'icon={아이콘:caret-right} date=1 strong=1,2'); $wn++; ?>
					</div>
					<!-- 토크 끝 -->
			...
			<div class="widget-box">
				<?php echo apms_widget('basic-post-slider', $wid.$wn, 'center=1 nav=1', 'auto=0'); $wn++; ?>
			</div>
			<!-- 배너 끝 -->	
		...
		<div class="col-md-3<?php echo ($side == "left") ? ' pull-left' : '';?> at-col at-side">
			...
			<div class="row">
				<div class="col-md-12 col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-list', $wid.$wn, 'icon={아이콘:bell} date=1 strong=1,3'); $wn++; ?>
					</div>
					<!-- 알림 끝 -->
				...
				<div class="col-md-12 col-sm-6">
					...
					<div class="widget-box">
						<?php echo apms_widget('basic-post-list', $wid.$wn, 'icon={아이콘:comment} comment=1 date=1 strong=1,2'); $wn++; ?>
					</div>
					<!-- 댓글 끝 -->
			...
			<!-- 설문 시작 -->
			<?php // 설문조사
				$is_poll_list = apms_widget('basic-poll', $wid.$wn, 'icon={아이콘:commenting}'); $wn++;
				if($is_poll_list) {
			?>
				<div class="div-title-underbar">
					<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
